...
const LoginInput = (props) => {
    ...
    return (
        <div className={styles.loginInputContainer}>
            ...
            <input value={props.value} onChange={(event) => props.onChange(event)} autoComplete={props.autocomplete} type={props.showPassword ? 'none' : 'password'} className={styles.loginInput} placeholder={props.placeholder}/>
